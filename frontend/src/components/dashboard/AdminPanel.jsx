...
const AdminPanel = () => {
  ...
  const tabs = [
    ...
    { id: 'live-results', label: 'Live Results', icon: FaEye },
...
// Live Results Content Component
const LiveResultsContent = () => {
        ...
        <div className="card bg-base-100 shadow-xl">
          <div className="card-body text-center py-12">
            ...
            <p className="text-base-content/60">
              No elections are currently available for live results
            </p>
          </div>
        </div>
      )}
