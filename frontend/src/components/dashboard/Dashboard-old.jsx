    ...
    <div className="max-w-7xl mx-auto p-6">
      ...
      <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="stat bg-base-100 border border-base-300 rounded-lg">
          ...
          <div className="stat-desc">Currently voting</div>
        </div>
        ...
        <div className="stat bg-base-100 border border-base-300 rounded-lg">
          ...
          <div className="stat-desc">Votes cast</div>
        </div>
        ...
        <div className="stat bg-base-100 border border-base-300 rounded-lg">
          ...
          <div className="stat-desc">Overall rate</div>
        </div>
      </motion.div>
        ...
        <motion.div variants={itemVariants} className="lg:col-span-2">
          <div className="card bg-base-100 border border-base-300">
            <div className="card-body">
              ...
              <p className="text-base-content/60 mb-4">Elections you can vote in right now</p>
              ...
              {electionsLoading ? (
                ...
                <div className="space-y-3">
                  {elections.elections.map((election) => (
                    <div key={election._id} className="flex items-center justify-between p-3 bg-base-200 rounded-lg">
                      <div>
                ...
                <div className="text-center py-8">
                  <MdInbox className="text-4xl mx-auto mb-2 text-base-content/40" />
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  <div className="flex-1 text-sm">
                    <p>Voted in Student Council Election</p>
                    <p className="text-base-content/60">2 hours ago</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  <span className="w-2 h-2 bg-primary rounded-full"></span>
                  <div className="flex-1 text-sm">
                    <p>Earned "Early Voter" NFT badge</p>
                    <p className="text-base-content/60">1 day ago</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  ...
                  <div className="flex-1 text-sm">
                    ...
                    <p className="text-base-content/60">3 days ago</p>
                  </div>
                </div>
              </div>
            </div>
